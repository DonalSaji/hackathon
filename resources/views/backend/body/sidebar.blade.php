...
<div class="leftside-menu">
    ...
    <a href="{{ route('dashboard') }}" class="logo logo-light">
        <span class="logo-lg">
            <img src="{{ asset('assets/images/Portfolio_Admin.png') }}" style="padding-left:8px" alt="logo">
        </span>
        <span class="logo-sm">
            <img src="{{ asset('assets/images/Portfolio_Admin-sm.png') }}" style="padding-left:8px" alt="small logo">
        </span>
    </a>
    ...
    <a href="{{ route('dashboard') }}" class="logo logo-dark">
        <span class="logo-lg">
            <img src="{{ asset('assets/images/Arya Fire Safety Logo Light.png') }}" alt="dark logo"
                style="margin: 0 18px;">
        </span>
        <span class="logo-sm">
            <img src="{{ asset('assets/images/Arya Fire Safety Logo Light.png') }}" alt="small logo"
                style="margin: 0 18px;">
        </span>
    </a>
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            {{-- @can('menu.leads')
                <li class="side-nav-item">
                    <a href="{{ route('all.leads') }}" class="side-nav-link">
                        <i class="mdi mdi-calendar-clock"></i>
                        <span class="badge bg-success text-white float-end">New</span>
                        <span> Due Dates (Leads)</span>
                    </a>
                </li>
            @endcan --}}
            ...
            @can('menu.rolepermissions')
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#allpermission" aria-expanded="false" aria-controls="allpermission"
                        class="side-nav-link">
                        <i class="mdi mdi-account-cog"></i>
                        <span> Roles & Permission </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="allpermission">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="support">
                        <ul class="side-nav-second-level">
                            @can('all.telecall')
                                <li>
                                    <a href="{{ route('telecalls') }}">Telecalls</a>
                                </li>
                            @endcan
                            @can('all.ticket')
                                <li>
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="utilities">
                        <ul class="side-nav-second-level">
                            @can('activity.logs')
                                <li>
                                    <a href="{{ route('activity.log') }}">Activity Logs </a>
                                </li>
                            @endcan
                        </ul>
                    </div>
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="settings">
                        <ul class="side-nav-second-level">
                            ...
                            @endcan
                            @can('all.notification.templates')
                                <li>
                                    <a href="{{ route('notification.templates') }}">
            ...
            <!--For user accounts related to Banks-->




            <!--User bank account section end-->

            {{--
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#alluser" aria-expanded="false" aria-controls="alluser"
                    class="side-nav-link">

         ...
         <div class="d-flex align-items-center gap-lg-2 gap-1">
             ...
             <div class="logo-topbar">
                 ...
                 <a href="{{ route('dashboard') }}" class="logo-light">
                     <span class="logo-lg">
                         <img src="{{ asset('assets/images/Portfolio_Admin.png') }}" alt="logo">
                     </span>
                     <span class="logo-sm">
                         <img src="{{ asset('assets/images/Arya Fire Safety Logo.png') }}" alt="logo">
                     </span>
                 </a>
                 ...
                 <a href="{{ route('dashboard') }}" class="logo-dark">
                     <span class="logo-lg">
                         <img src="{{ asset('assets/images/Arya Fire Safety Logo Light Small.png') }}" alt="logo">
                     </span>
                     <span class="logo-sm">
                         <img src="{{ asset('assets/images/Arya Fire Safety Logo Light Small.png') }}" alt="logo">
                     </span>
                 ...
                 <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg py-0">
                     <div class="p-2 border-top-0 border-start-0 border-end-0 border-dashed border">
                         <div class="row align-items-center">
                             ...
                             <div class="col-auto">
                                 <a href="{{ route('clear.notifications') }}" class="text-decoration-underline">
                                     <small>Clear All</small>
                                 </a>
                             </div>
                         </div>
                     ...
                     <div class="px-2" style="max-height: 250px;overflow-y:scroll;" id="noti-list">
                         <div></div>
                     ...
                     <span class="account-user-avatar">
                         <img id="userProfileImage"
                             src="{{ Auth::user()->profile && Auth::user()->profile->avatar
                                 ? route('files.view', Auth::user()->profile->avatar)
